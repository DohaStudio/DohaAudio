...
| Data | [Dataset 정책](05-data/dataset-policy.md) · [실제 Admission](05-data/real-dataset-admission.md) · [Archive Inspection](05-data/archive-membership-inspection.md) · [Path·Companion Policy](05-data/archive-path-companion-policy.md) | authority·rights·archive·path/companion Gate [구현], 승인 Dataset [미확보] |
